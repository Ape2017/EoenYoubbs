...
<div class="main-wrap">
    <div class="main">
			...
			<div class="home-box-list">';
				if($articledb){
					...
					<div class="ios-notifications">
						<p>您还没有关注过任何一个用户 或者 关注的用户还没有发布过帖子</p>
					</div>';
				}echo'
			</div>
		</div>
		<div class="main-sider">
			<div class="sider-box">
				<div class="sider-box-title">我关注了 ',$uu_obj['fuer'],' 人</div>
				<div class="sider-box-content">
					<div class="ios-slider-box-follw">';
				foreach($leavindb as $leaving){
					echo '<a href="/user/',$leaving['ObjID'],'" title="',$leaving['name'],'"><img src="/avatar/large/',$leaving['avatar'],'.png" alt="',$leaving['name'],'" /></a>';
				}echo'</div>
				</div>
				<div class="c"></div>
			</div>
